...
export default function CTA_6({ data = { enable: false } }) {
  return (
    <>
      {data?.enable && (
        <>
          <div className="max-w-6xl mt-12 mx-auto rounded-3xl card4-bg dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-gray-700 via-gray-900 dark:to-black px-6 py-16 text-center dark:border dark:border-gray-800 shadow-xl">
