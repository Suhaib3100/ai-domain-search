              ...
              >
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        {pageData?.featureTab?.tab2Title || "Advanced tools"}
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        {pageData?.featureTab?.tab2Desc ||
                          "Use Preline thoroughly thought and automated libraries to manage your businesses."}
                      </span>
                    </span>
                  </span>
                ...
                >
                  <span className="flex">
                    ...
                    <span className="grow ms-6">
                      <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">
                        {pageData?.featureTab?.tab3Title || "Advanced tools"}
                      </span>
                      <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                        {pageData?.featureTab?.tab3Desc ||
                          "Use Preline thoroughly thought and automated libraries to manage your businesses."}
                      </span>
                    </span>
                  </span>
                ...
                <div>
                  ...
                  >
                    <img
                      ...
                      src={
                        pageData?.featureTab?.tab1Image?.split("public")[1] ||
                  ...
                  >
                    <img
                      className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]"
                      src={
                        pageData?.featureTab?.tab2Image?.split("public")[1] ||
                  ...
                  >
                    <img
                      className="shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]"
                      src={
                        pageData?.featureTab?.tab3Image?.split("public")[1] ||
